...
/**
  ...
  */
class NegByteCode extends ByteCode with ByteCodeValues {
  ...
  /**
    ...
    * The bytecode operation 'ineg' pops the top value from the virtual machine stack, negates it and pushes the result
    * VM.push(-VM.pop())
